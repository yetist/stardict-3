...
bool stardict_plugin_init(StarDictPlugInObject *obj, IAppDirs* appDirs)
{
	...
	obj->info_xml = g_strdup_printf("<plugin_info><name>%s</name><version>1.0</version><short_desc>%s</short_desc><long_desc>%s</long_desc><author>Hu Zheng &lt;huzheng001@gmail.com&gt;</author><website>http://www.stardict.org</website></plugin_info>", _("Flite"), _("Flite TTS."), _("Pronounce words by Flite TTS engine."));
